...
export class ExerciseController {
  static async index(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res
        .status(200)
        .json({ message: 'Successfully retrieved exercises', ...response });
    } catch (e) {
      next(e);
    }
  }
  ...
  static async show(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res
        .status(200)
        .json({ message: 'Successfully retrieved exercise', data: response });
    } catch (e) {
      next(e);
    }
  }
  ...
  static async store(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res
        .status(201)
        .json({ message: 'Successfully stored exercise', data: response });
    } catch (e) {
      next(e);
    }
  }
  ...
  static async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res
        .status(200)
        .json({ message: 'Successfully updated exercise', data: response });
    } catch (e) {
      next(e);
    }
  }
